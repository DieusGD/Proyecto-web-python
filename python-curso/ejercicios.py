...
def ej5():
    ...
    # ingr = float(input("escribe tus ingresos mensuales: "))
    # if edad >= 16 and ingr >= 1000:
    #     print("debes de tributar")
    # else:
    #     print("aun no debes de tributar, ")
    "hola"
...
#     nom = str(input("como te llamas? \n"))
#     sex = str(input("cual es tu sexo? Mujer u Hombre\n"))
#     if nom.lower() <= "m":
#         if sex.lower == "m":
#             grupo = "A"
#         else:
...
# Escribir un programa que pregunte al usuario su renta anual y muestre por pantalla el tipo impositivo que le corresponde.
    rent = float(input("cual es tu renta anual? \n"))
    while rent < 10000:
        print("te toca el 5%")
        break
    while rent >= 10000 and rent <20000:
        print("te toca el 15%")
        break
    while rent >= 20000 and rent <35000:
        print("te toca el 20%")
        break
    while rent >= 35000 and rent <60000:
        print("te toca el 30%")
        break
    while rent > 60000:
        print("te toca el 45%")
